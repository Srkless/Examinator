...
function ActivitiesForm() {
    ...
    const [activityDialogText, setActivityDialogText] = useState(
        ...
        if (update) {
            ...
            if (activity.results.length !== 0) {
                setWarningDialogText(
                    `Neki studenti imaju već unesene bodove za ovu aktivnost.\nAko nastavite, svi bodovi će biti trajno obrisani.`,
                );
            } else {
    ...
    return (
        <div>
            ...
            <main className="main-content activities-container">
                <div className="activity-subject-row">
                ...
                <section>
                    ...
                    <div id="activitiesContainer">
                        {activities.filter(
                            ...
                            <p className="no-data">
                                Trenutno nemate ni jednu aktivnost na predmetu
                            </p>
                        )}
                    </div>
                </section>
                ...
                <section className="formule-section">
                    ...
                    <div id="formulasContainer">
                        {formulas.filter(
                            (formula) => formula.schoolYear == selectedYear,
                        ).length > 0 ? (
                            <table>
                                <thead>
                                    <tr>
                            ...
                            <p className="no-data">
                                Trenutno nemate ni jednu formulu na predmetu
                            </p>
                        )}
                    </div>
                </section>
            ...
            <dialog id="activityDialog" ref={activityDialogRef}>
                ...
                >
                    <div className="dialog-header">
                        ...
                        <button
                            type="button"
                            id="closeActivityDialog"
                            className="close-btn"
                            onClick={() => closeDialog(activityDialogRef)}
                        >
                    ...
                    <input
                        ...
                        min="0"
                        required
                        value={activityMaxPoints}
                        onChange={(e) => setActivityMaxPoints(e.target.value)}
                    />
            ...
            <dialog
                ...
                onCancel={() => closeDialog(formulaDialogRef)}
            >
                <form
                    method="dialog"
                    id="formulaForm"
                ...
                >
                    <div className="dialog-header">
                        ...
                        <button
                            type="button"
                            id="closeFormulaDialog"
                            className="close-btn"
                            onClick={() => closeDialog(formulaDialogRef)}
                        >
                            <span className="material-icons">close</span>
                        </button>
                    </div>
                    ...
                    <div className="inline-buttons">
                        ...
                        <div className="group" id="activityTags">
                            {activities
                                .filter(
                                    (activity) =>
                                        activity.schoolYear == selectedYear,
                                )
                                .map((activity, i) => (
                                    <button
                                        type="button"
            ...
            <dialog
                ...
                onCancel={() => closeDialog(warningDialogRef)}
            >
                <form
                ...
                >
                    <div className="dialog-header">
                        ...
                        <button
                            ...
                            className="close-btn"
                            onClick={() => closeDialog(warningDialogRef)}
                        >
                            <span className="material-icons">close</span>
                        </button>
                    </div>
