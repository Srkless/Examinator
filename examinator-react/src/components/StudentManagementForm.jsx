    ...
    return (
        <div>
            ...
            <main className="main-content students-container">
                <div className="studentMan-subject-row">
                    ...
                    <div className="student-buttons">
                        ...
                        <button
                            id="addStudentBtn"
                            data-tooltip="Dodaj studenta"
                            onClick={() =>
                                openDialog(
                                    studentDialogRef,
                                    'Dodavanje novog studenta na predmet',
                                    false,
                                )
                            }
                        >
                    ...
                    <section>
                        ...
                        <div id="studentsContainer">
                            {!isYearsLoaded ? (
                                ...
                                <p className="no-data">
                                    Trenutno nema ni jednog studenta na predmetu
                                </p>
                            )}
                        </div>
            ...
            <dialog
                ...
                id="studentDialog"
                onCancel={() => closeDialog(studentDialogRef)}
            >
                <form method="dialog" id="studentForm" onSubmit={handleSubmit}>
                    <div className="dialog-header">
                        ...
                        <button
                            type="button"
                            className="close-btn"
                            id="closeStudentDialog"
                            onClick={() => closeDialog(studentDialogRef)}
                        >
